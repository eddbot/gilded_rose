...
class GildedRoseTest {
    ...
    @Test
    void normal_item_sell_in_decrements_by_one() {
    ...
    @Test
    void normal_item_quality_degrades_by_one_when_sell_in_not_reached() {
    ...
    @Test
    void normal_item_quality_degrades_by_two_when_sell_in_reached() {
    ...
    @Test
    void normal_item_quality_cannot_be_negative() {
        Item[] items = new Item[]{new Item("normal_item", 0, 0)};
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals("normal_item", app.items[0].name);
    ...
    void sulfuras_being_a_legendary_item_never_has_to_be_sold_or_decreases_in_quality() {
        Item[] items = new Item[]{new Item(GildedRose.SULFURAS, 0, 80)};
        GildedRose app = new GildedRose(items);
        app.updateQuality();
